...
<div class='form-group'>
    ...
    {{ Form::radio('parking_available', 'Yes', (Input::old('parking_available') == 'Yes'), ['class' => 'radio']) }} {{ Form::label('parking_available', 'Yes') }}
    {{ Form::radio('parking_available', 'No', (Input::old('parking_available') == 'No'), ['class' => 'radio']) }} {{ Form::label('parking_available', 'No') }}
    {{ $errors->first('parking_available', '<br><div class="alert alert-info">:message</div>') }}
</div>
<div class='form-group'>
    {{ Form::label('open_hour', 'Open:') }}
    {{ Form::text('open_hour', Input::old('open_hour'), ['class' => 'form-control timepicker', 'id' => "open_hour"]) }}
    {{ $errors->first('open_hour', '<br><div class="alert alert-info">:message</div>') }}
</div>
<div class='form-group'>
    {{ Form::label('close_hour', 'Close:') }}
    {{ Form::text('close_hour', Input::old('close_hour'), ['class' => 'form-control timepicker', 'id' => 'close_hour']) }}
